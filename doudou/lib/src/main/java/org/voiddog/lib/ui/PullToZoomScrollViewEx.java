...
public class PullToZoomScrollViewEx extends PullToZoomBase<ScrollView> {
    protected static final String TAG = PullToZoomScrollViewEx.class.getSimpleName();
    protected boolean isCustomHeaderHeight = false;//自定义header高度之后可能导致zoomView拉伸不正确
    ...
    protected class ScalingRunnable implements Runnable {
