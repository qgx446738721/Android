...
public abstract class Request<T> implements Comparable<Request<T>> {
	...
	private final Response.ProgressListenr mProgressListenr;
	...
	public Request(int method, String url,
			Response.ProgressListenr progressListener,
			Response.ErrorListener listener) {
		mMethod = method;
		mUrl = url;
		mErrorListener = listener;
		mProgressListenr = progressListener;
		setRetryPolicy(new DefaultRetryPolicy());
	...
	public Response.ProgressListenr getProgressListenr() {
		return mProgressListenr;
	}
	...
	public void deliverProgress(int currentBytes, int totalBytes) {
		if (mProgressListenr != null) {
			mProgressListenr.onProgress(currentBytes, totalBytes);
		}
	}
