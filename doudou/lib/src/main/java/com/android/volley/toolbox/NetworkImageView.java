...
public class NetworkImageView extends ImageView {
	...
	private ProgressListenr mProgressListener;
...
//	    }
	...
	public void setProgressListener(ProgressListenr listenr) {
		mProgressListener = listenr;
	}
	...
	void loadImageIfNecessary(final boolean isInLayoutPass) {
		...
		ImageContainer newContainer = mImageLoader.get(mUrl,
				...
				}, maxWidth, maxHeight, mProgressListener);
